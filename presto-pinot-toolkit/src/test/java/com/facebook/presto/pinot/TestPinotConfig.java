...
public class TestPinotConfig
{
    ...
    public void testDefaults()
    {
        ConfigAssertions.assertRecordedDefaults(
                ConfigAssertions.recordDefaults(PinotConfig.class)
                        ...
                        .setUseReverseProxy(false)
                        .setReverseProxyUrl(null)
                        .setReverseProxyTargetHeaderName(null)
                        ...
                        .setUseHttpsForReverseProxy(false)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("pinot.use-https-for-reverse-proxy", "true")
        ...
        PinotConfig expected = new PinotConfig()
                ...
                .setReverseProxyUrl("localhost:2222")
                ...
                .setUseHttpsForReverseProxy(true)
